...
const createSmallCards = (data) => {
    ...
    <div class="sm-product">
        ...
        <div class="item-counter">
            ...
            <p class="item-count" data-price="${data.price}">${data.item * data.item}</p>
            <button class="counter-btn increment">+</button>
        </div>
        <p class="sm-price">${data.price}</p>
        <button class="sm-delete-btn"><img src="/public/img/close.png" alt=""></button>
    </div>
    `
}
...
const setCartProducts = () => {
    ...
    if(cart == null || !cart.length){
        cartContainer.innerHTML += `<img src="/public/img/empty-cart.png" class="empty-img" alt="">`
    }else{
